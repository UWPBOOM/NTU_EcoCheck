...
fun HistoryScreen(
    ...
    if (showClearDialog) {
        AlertDialog(
            ...
            title = { Text("确认清空") },
            text = { Text("确定要清空所有查询历史吗？此操作不可撤销。") },
            confirmButton = {
                Button(
                    onClick = {
...
@Composable
private fun HistoryCard(record: QueryHistoryEntity) {
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = "${record.campus} ${record.building} ${record.room}",
